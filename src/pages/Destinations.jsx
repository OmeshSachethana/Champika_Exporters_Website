...
import kuwaitImg from '../assets/Kuwait.jpg';
import bahrainImg from '../assets/Bahrain.png';
...
const Destinations = () => {
  const destinations = [
    ...
    },
    {
      ...
      country: 'Turkey',
      image:
        'https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
      description:
    ...
    },
    {
      ...
      country: 'Russia',
      image:
        'https://images.unsplash.com/photo-1513326738677-b964603b136d?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
      description:
            ...
            >
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src =
                    'https://images.unsplash.com/photo-1500835556837-99ac94a94552?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80';
                }}
              />
              <div className="p-6">
